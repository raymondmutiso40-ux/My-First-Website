...
import AddEntryForm, { CompanyOption } from "@/components/AddEntryForm";
...
export default async function DashboardPage() {
  const [rows, companies] = await Promise.all([getComplianceRows(), getCompanies()]);
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <AddEntryForm companies={companies} />
